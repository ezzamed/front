...
/*getParticularHero(idi): Observable<Demographie> {
 ...
 addAll(list): Observable<any>{
  ...
  // liste des vaccinations pour une campagne et un agent
  getAgentCampagnesVaccinations(idCampagne, idAgent){
    return this.httpClient.get(this.host+"/campagne/agent/vaccinations/"+idCampagne+"/"+idAgent);
  }

  //getAllCampagnes
  getAllCampagnes(){
    return this.httpClient.get(this.host+"/campagne/all");
  }
